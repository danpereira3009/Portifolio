...
<div className="h-[80vh] w-[80vw] text-white relative top-12 left-12">

    <div>
        <h1 className="text-6xl">Olá, <br/> Meu nome é <span className="text-red-600">D</span>aniel <br/> web developer</h1>
    </div>
